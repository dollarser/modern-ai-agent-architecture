...
> **来源类型：** Fact —— 基于 MCP 规范 v2025-06-18。文中最小示例仍按 v2024-11-05 的能力集合讲解，不能直接作为当前协议实现；实现时请以 [spec.modelcontextprotocol.io](https://spec.modelcontextprotocol.io/) 的最新版本为准。
...
> **来源类型：** Fact —— 基于 MCP v2025-06-18 的 Lifecycle、Client Features 与 Server Features；具体 Host 的 UI 和审批策略属于产品实现
...
> **来源类型：** Fact + 推导分析 —— 授权机制依据 MCP v2025-06-18 Authorization；Tool 级审批是本书的 Host 安全设计建议
...
| REF-5 | [MCP Lifecycle](https://modelcontextprotocol.io/specification/2025-06-18/basic/lifecycle) | 官方规范 | 初始化、能力协商、超时与关闭 |
| REF-6 | [MCP Authorization](https://modelcontextprotocol.io/specification/2025-06-18/basic/authorization) | 官方规范 | HTTP 传输的授权边界 |
